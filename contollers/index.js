...
class Controller {
    ...
    static async newEmployeeAddedData (req,res){
        ...
        let dataEmployee = await Employee.create({firstName:req.body.firstName, lastName:req.body.lastName, dateOfBirth:req.body.dateOfBirth, 
        ...
        static async editedEmployeeData (req,res){
            try {
              ...
              console.log(req.body);
                await Employee.update({ firsName:req.body.firstName,lastName:req.body.lastName,dateOfBirth:req.body.dateOfBirth,
